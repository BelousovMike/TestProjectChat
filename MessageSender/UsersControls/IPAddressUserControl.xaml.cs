...
{
    /// <summary>
    /// Interaction logic for IPAddressUserControl.xaml
    /// </summary>
    public partial class IPAddressUserControl : UserControl
    {
        ...
        public static readonly DependencyProperty AddressProperty = DependencyProperty.Register(
            "Address", typeof(string), typeof(IPAddressUserControl), new FrameworkPropertyMetadata(default(string), AddressChanged)
            {
